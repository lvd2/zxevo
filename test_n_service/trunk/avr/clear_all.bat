...
if exist deflang.inc del /f /q deflang.inc
if exist service.hex del /f /q service.hex
if exist service.eep.hex del /f /q service.eep.hex
if exist service.cof del /f /q service.cof
if exist service.lst del /f /q service.lst
if exist service.obj del /f /q service.obj
