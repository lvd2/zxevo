...
enum SYNC_MODE { SM_SOUND, SM_TSC, SM_VIDEO };
...
struct COMPUTER
{
   ...
   u8 fddIO2Ram_mask;
	...
	struct{
		u8 p83;	//#83AB – порт управления прерываниями и сбросом
		u8 p82;	//#82AB – порт управления W5300
		u8 memEna;
	}wiznet;
...
#define RF_D3DE     0x00400000  // use d3d for full screen mode
